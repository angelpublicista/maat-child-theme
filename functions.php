...
function maat_resources_scripts(){
	if(is_post_type_archive('recursos_cp') || is_single('recursos_cp') || is_page('recursos') || is_tax('maat_type_resource')){
...
// Scripts logros
function maat_logros_scripts(){
	wp_enqueue_style('maat-logros-css', get_stylesheet_directory_uri() . "/assets/css/mt-logros.css" ,array(), null);
	wp_enqueue_script('maat-logros-js', get_stylesheet_directory_uri() . "/assets/js/maat-logros.js",array('jquery'),"1.0",true);
}

add_action('wp_enqueue_scripts','maat_logros_scripts');
...
require_once('inc/custom-post-types/cpt-lineas-negocio.php');
require_once('inc/custom-post-types/cpt-logros.php');
require_once('inc/taxonomies/tax-tipo-recurso.php');
require_once('inc/shortcodes/sc-grid-tipos-recursos.php');
require_once('inc/shortcodes/sc-grid-logros.php');
