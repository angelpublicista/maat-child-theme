...
if ( ! function_exists( 'maat_type_resource_func' ) ) {

    // Register Custom Taxonomy
    function maat_type_resource_func() {
    
        $labels = array(
            'name'                       => _x( 'Tipo', 'Taxonomy General Name', 'text_domain' ),
            'singular_name'              => _x( 'Tipo', 'Taxonomy Singular Name', 'text_domain' ),
            'menu_name'                  => __( 'Tipo recurso', 'text_domain' ),
    ...
    add_action( 'init', 'maat_type_resource_func', 0 );
